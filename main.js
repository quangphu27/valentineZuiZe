...
function firstQuestion(){
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire({
                title: 'Hello',
                text: 'Valentine này em có muốn nhận quà không? Nếu có thì... anh đây nè! Valentine này em có muốn được tặng một món quà đáng yêu không? Nếu có, hãy nhìn vào gương nhé! 😆',
                imageUrl: 'baner.jpg',
                background: '#fff url("iput-bg.jpg")',
                imageAlt: 'Custom image',
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            ...
                                            Swal.fire({
                                                ...
                                                background: '#fff url("iput-bg.jpg")',
                                                title: 'Chúc em một mùa Valentine vui vẻ không quạo nha🥰😘😘',
